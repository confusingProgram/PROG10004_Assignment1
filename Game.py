...
# chapter 3
        ...
        print(c2._name + ''': "123 That Street, OH! found it!"''')
        ...
        print(c2._name + ''': "ohh what do we have here?"''')
        ...
        print("You could try to fling the dog off your leg; put the boxes down and bark back; or run away while the dog chases you.")


     def chapter_3_challenge(c2):
         if c2._role == "mc": #mail courier
        option = ""
  while True: # Selection loop
            op1 = "fling the dog off your leg" # requires 8 strength
            op2 = "put the boxes down and bark back" # requires 7 dexterity to pass
            op3 = "run away while the dog chases you " # requires 7 intelligence to pass 
...
def chapter_3_challenge(c1):
    if c1._role == "pd": #pizza driver
        ...
        while True: # Selection loop
            ...
            op3 = "intimidate them" # requires 7 charisma to pas
        ...
        if option == "1":
            print("fling the dog off your leg requires a roll of 8 in order to complete the challenge.")
            input("Press Enter to roll the dice.")
            num = roll_dice(c2._str)
            if num > 10: #11-12
                print("Critical win! With one fell flick, the dog falls down and scurries away.")
                c2.challenge_result(3, 1)
                c2.mod_stat(str, 1)
            elif num > 6: #7-10
                ...
                c2.challenge_result(3, 0)
            else: #2-3
                print("Critical lose! The dog's bite so severe that you end up in a hospital.")
                c2.challenge_result(3, 0)
        elif option == "2":
            print("Drop the boxes and bark back at the dog requires a roll of 7 in order to  complete the challenge.")
            input("Press Enter to roll the dice.")
            num = roll_dice(c2._dex)
            if num > 10: #11-12
                print("Critical win! Your barks intimidates the dog and runs away. Good job!")
                c2.challenge_result(3, 1)
            elif num > 6: #5-10
            ...
            print(" Run away while the dog chases you requires a roll of 7 in order to complete the challenge.")
            input("Press Enter to roll the dice.")
            num = roll_dice(c2._iq)
            if num > 10: #11-12
                ...
                print("Critical lose! The is still chasing you which cause you to trip and drop the boxes.")
                c2.challenge_result(3, 0)
