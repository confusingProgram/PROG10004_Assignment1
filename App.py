...
def ending_cutscene_mc(mc): # Win condition is dependant on whether challenge 3 was successful.
    ...
    if mc._challenge_3_result == 1:
        ...
        print('                     *Gives the device*                ')
        print('''Tony: "Sure!                   *takes the device*.''')
        print('''Tony:              *Signs and gives it back*''')
        print(mc.name+                        '''* Takes it*''')
        print(mc._name + ''': "Thank you. Here are your boxes and have a nice day!!."''')
        print('*SLAM*'.center(100, " "))
        ...
        print('''Tony: *Takes the boxes*''')
        print('Tony: "WHAT, YOU KNOW HOW EXPENSIVE THAT WAS?!"')
        print('*SLAM THE DOOR*'.center(100, " "))
