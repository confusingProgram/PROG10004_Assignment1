...
def ending_cutscene_pd(pd): # Win condition is dependant on whether challenge 3 was successful.
    ...
    if pd._challenge_3_result == 1:
        ...
        print(pd._name + ''': "Hello, are you Tony? Order of 3 pepperonis, and 12 pc. wings?"''')
        print('''Tony: "Yep, that's right! You look a little rough, everything alright?"''')
        print(pd._name + ''': "Just part of a day's work."''')
        print('''Tony: "Well, here's a tip, you deserve it."''')
...
def ending_cutscene_mc(mc): # Win condition is dependant on whether challenge 3 was successful.
    ...
    if mc._challenge_3_result == 1:
        ...
        print('      *SIGNS DEVICE*')
        print('      *GIVES DEVICE*')
        print(mc._name + ''': *TAKES DEVICE*''')
        print('''      "Thank you. Here are your boxes and have a nice day!"''')
        print('*SLAM*'.center(100, " "))
